        ...
        if (menu.equals("Productos")) {
            switch (accion) {
                ...
                case "Actualizar":
                    ...
                    String precioProductoUpdate = request.getParameter("txtPrecio");
                    String unidadProductoUpdate = request.getParameter("txtUnidad");
                    producto1.setDescripcion(descripcionProductoUpdate);
                    producto1.setNombreProducto(nombreProductoUpdate);
                    producto1.setUnidad(unidadProductoUpdate);
                    producto1.setPrecio(precioProductoUpdate);
                    producto1.setCodigo(idProducto);
